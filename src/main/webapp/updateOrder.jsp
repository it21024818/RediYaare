...
<title>RediYaare: Update order</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/mainStyles.css">
...
<!-- Header -->
	...
	<h1 style="text-align: center;">Update the Order</h1>
	...
	<form action="updateOrderServlet" method="post">
		...
		<input type="date" id="pickupDate" name="pickupDate" value="<%= pickupDate %>">
		<br><br>
		<label>Delivery date:	</label>
		<input type="date" id="deliveryDate" name="deliveryDate" value="<%= deliveryDate %>">
		<br><br>
		<label>Location:	</label>
		<input style="width:75%;" type="text" name="address" value="<%= address %>">
		<br><br>
		<input type="submit" class="submitBtn" name="submit" value="Update order"><br>
	</form>
